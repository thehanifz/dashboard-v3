    ...
    <div className="p-4 md:p-5 space-y-4 overflow-auto h-full custom-scrollbar view-enter pb-20 md:pb-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 md:gap-4">
        ...
        <KpiCard
          ...
          value={stats.doneBai.toLocaleString("id-ID")}
        ...
        <KpiCard
          ...
          value={stats.paCancel.toLocaleString("id-ID")}
      ...
      <div className="rounded-2xl p-5" style={{ background: "var(--bg-surface)", border: "1px solid var(--border)" }}>
        ...
        <div className="flex flex-col gap-1 mt-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <span className="text-[11px]" style={{ color: "var(--text-muted)" }}>
            {stats.onProgress.toLocaleString("id-ID")} {stats.valProgress || "On Progress"} · {stats.paCancel.toLocaleString("id-ID")} {stats.valCancel || "Cancel"}
          </span>
        </div>
      </div>
      ...
      {dashboardFilter && (
        <div className="flex items-center justify-between p-3 rounded-xl"
          ...
          <div className="flex items-center gap-2">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" style={{ color: "var(--accent)" }}>
      ...
      <div className="grid min-w-0 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-4">
        ...
        <SectionCard title="Per KATEGORI PRODUK" subtitle="Kategori produk layanan">
          <div className="space-y-2.5">
        ...
        <SectionCard title="Per JENIS PEKERJAAN" subtitle="Jenis pekerjaan">
          <div className="space-y-2.5">
      ...
      <div className="grid min-w-0 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-4">
        ...
        <SectionCard title="Per PTL UPDATE" subtitle="PTL yang update">
          <div className="space-y-2.5">
        ...
        <SectionCard title="Per SEGMENTASI" subtitle="Segmentasi customer">
          <div className="space-y-2.5">
      ...
      <SectionCard
        ...
        action={
          isEngineer ? (
            <button onClick={() => setShowAging(true)} title="Atur threshold aging"
